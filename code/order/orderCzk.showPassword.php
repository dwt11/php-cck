...
if ($dopost == 'getpassword') {
    ...
    $nquery = " SELECT czk_password FROM #@__order_addon_czk  WHERE id='{$orderAddonId}'";
...
<div class="wrapper wrapper-content animated fadeInRight" style="background-color: #ffffff">
    <form name="form1" id="form1" action="" method="post" class="form-horizontal">
        ...
        <div class="form-group">
            <div class="col-sm-12">
                <input type="text" class="form-control pword m-b" placeholder="请先验证登录密码" onfocus="this.type='password'" autocomplete="off" name="pwd" id="pwd"/>
            </div>
            <div class="col-sm-12">
