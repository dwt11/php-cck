...
if ($dopost == 'save') {
    ...
    //更新
    $completetime = time();
    $sql = "UPDATE `x_sys_feedback` SET `completeTime`='$completetime', `completeBody`='$completebody', `filename`='$filename11' WHERE id='$id' ";
...
if ($dopost == '') {
    ...
    //读取 信息
    $query = "SELECT *  FROM #@__sys_feedback  WHERE id='$id' ";
