...
if ($dopost == "save") {
    ...
    $upquery = "UPDATE `#@__device_type` SET
     sortrank='$sortrank',
     typename='$typename',
...
//读取分类信息
$dsql->SetQuery("SELECT tp.* FROM `#@__device_type` tp  WHERE tp.id=$id");
$myrow = $dsql->GetOne();
$topid = $myrow['topid'];
...
-->
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-2">
                                <input type="text" class="form-control" name="tempdevice" value="<?php echo $myrow['tempdevice'] ?>"/>
