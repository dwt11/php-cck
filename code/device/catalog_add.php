...
if ($dopost == 'save') {
    ...
    $in_query = "INSERT INTO `#@__device_type`(reid,topid,sortrank,typename,ispart,tempindex,templist,tempdevice,channeltype,`content`)
    VALUES('$reid','$topid','$sortrank','$typename','$ispart','$tempindex','$templist','$tempdevice','$channeltype','$content')";
...
if ($dopost == '') {
    ...
    $topid = 0;
    if ($id > 0) {
        $myrow = $dsql->GetOne(" SELECT tp.* FROM `#@__device_type` tp WHERE tp.id=$id ");
                    ...
                    <form name="form1" id="form1" action="catalog_add.php" method="post" class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-2">
                                ...
                                <input type="text" class="form-control" name="tempindex" value="device_index.htm"/>
...
-->
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-2">
                                <input type="text" class="form-control" name="templist" value="device_list.htm"/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-2">
                                <input type="text" class="form-control" name="tempdevice" value="device_view.htm"/>
