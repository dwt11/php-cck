...
<div class="main">
    ...
    <form id="form1" class="form-horizontal" method="post">
        ...
        <div class="alert alert-info">
            ...
            <div class="text-danger font-bold text-center">500以上可转账,500以下不可以转账,</div>
            ...
            <div class="text-center">
                ...
                if ($kyed > 0) {
                    ...
                    echo "<button type=\"submit\" class=\"btn btn-primary\">确转账到此账户</button>";
                } else {
                    echo "<button type=\"submit\" class=\"btn btn-primary\" disabled='disabled'>不可转账</button>";
                }
                ?>
...
<script>
    $(document).ready(function () {
        ...
        $("#form1").validate({
            rules: {
                jbnum: {number: true, required: true, min: 0, max: <?php echo $kyed ?>},
