 ...
 * 获取当前频道的下级栏目的内容列表标签
 *
 * @version        $Id: channelartlist.lib.php 1 9:29 6日
...
<demo>
{dwt:channelartlist row=6}
<dl>
 <dt><a href='{dwt:field name='typeurl'/}'>{dwt:field name='typename'/}</a></dt>
 <dd>
 {dwt:arclist titlelen='42' row='10'}    <ul class='autod'> 
     <li><a href="[field:arcurl /]">[field:title /]</a></li>
      <li>([field:senddate function="MyDate('m-d',@me)"/])</li>
    </ul>
{/dwt:arclist}
</dl>
{/dwt:channelartlist}
...
require_once('../web/partview.class.php');
...
function lib_channelartlist(&$ctag,&$refObj)
{
    ...
    $dsql->SetQuery("SELECT id,typename,ispart FROM `#@__archives_type` WHERE $tpsql   ORDER BY   sortrank ASC LIMIT $totalnum");
    $dsql->Execute();
