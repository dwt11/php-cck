 ...
 * 视图类
 *
 * @version        $Id: arc.partview.class.php
 * @package
 * @copyright
 * @license
 * @link
...
class PartView
{
     ...
     * @param bool|int $needtypelink 是否需要栏目连接
     */
    ...
    function SetTemplet($temp,$stype="file")
    {
        ...
        if($this->TypeID > 0)
        {
            ...
            $this->Fields['title'] = $this->TypeLink->GetArchivePositionLink(false);
        }
        $this->ParseTemplet();
    }
    ...
    function ParseTemplet()
    {
        ...
        if($this->TypeID>0)
        {
            $GLOBALS['envs']['topid'] = GetArchiveTopid($this->TypeID);
        }
        else 
        {
        ...
        MakeOneTag($this->dtp,$this); //这个函数在 channelunit.helper.php 文件中
    }
