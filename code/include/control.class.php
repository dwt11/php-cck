 ...
 * 织梦控制器基类
 *
 * @version        $Id: control.class.php 1 10:33 6日
 * @package
 * @copyright
 * @license
 * @link
...
class Control
{
    ...
    {
        global $dsql;
        $this->tpl = isset($this->tpl)? $this->tpl : new DwtTemplate();
        $sqltype = "DwtSql";
        //if ($GLOBALS['cfg_mysql_type'] == 'mysqli' && function_exists("mysqli_init")) $sqltype = "DwtSql";
        //else $sqltype = "DwtSqli";
