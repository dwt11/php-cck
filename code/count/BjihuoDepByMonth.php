...
$query = "
SELECT COUNT(#@__ztc_jihuo.orderListId) AS jihuocount, #@__ztc_jihuo.dep_id,x_emp_dep.dep_name
FROM  #@__ztc_jihuo 
...
//模板
if (empty($s_tmplets)) $s_tmplets = 'BjihuoDepByMonth.htm';
